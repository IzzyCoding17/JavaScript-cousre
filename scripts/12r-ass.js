let score = JSON.parse(localStorage.getItem("score")) || {
     ...
     // }
      ...
      const buttonElement = document.querySelector('.js-rock-btn');
      ...
      function showResetConfirmation(){
        ...
        <button class = "js-reset-confirmation-yes reset-confirm-btnn">
         Yes
        </button>
        <button class ="js-reset-confirmation-no reset-confirm-btn">
          No        
        </button>`
